...
def add_velocity_to_node(node, velocity):
    velocity_node = create_element("vector", name="velocity")
    velocity_node.set("x", str(velocity[0]))
    velocity_node.set("y", str(velocity[1]))
    velocity_node.set("z", str(velocity[2]))
    node.append(velocity_node)
