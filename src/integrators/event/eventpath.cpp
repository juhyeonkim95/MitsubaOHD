 ...
 * }
 */
class MIEventPathTracer : public MonteCarloIntegrator {
public:
    MIEventPathTracer(const Properties &props)
    ...
    MIEventPathTracer(Stream *stream, InstanceManager *manager)
...
MTS_IMPLEMENT_CLASS_S(MIEventPathTracer, false, MonteCarloIntegrator)
MTS_EXPORT_PLUGIN(MIEventPathTracer, "MI path tracer");
MTS_NAMESPACE_END
