 ...
 * }
 */
class MIEventCorrelatedPathTracer : public MonteCarloIntegrator {
public:
    MIEventCorrelatedPathTracer(const Properties &props)
    ...
    MIEventCorrelatedPathTracer(Stream *stream, InstanceManager *manager)
    ...
    std::string toString() const {
        ...
        oss << "MIEventCorrelatedPathTracer[" << endl
...
MTS_IMPLEMENT_CLASS_S(MIEventCorrelatedPathTracer, false, MonteCarloIntegrator)
MTS_EXPORT_PLUGIN(MIEventCorrelatedPathTracer, "MI path tracer");
MTS_NAMESPACE_END
