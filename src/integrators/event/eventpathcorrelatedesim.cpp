 ...
 * }
 */
class MIEventCorrelatedESIMPathTracer : public MonteCarloIntegrator {
public:
    MIEventCorrelatedESIMPathTracer(const Properties &props)
    ...
    MIEventCorrelatedESIMPathTracer(Stream *stream, InstanceManager *manager)
    ...
    std::string toString() const {
        ...
        oss << "MIEventCorrelatedESIMPathTracer[" << endl
...
MTS_IMPLEMENT_CLASS_S(MIEventCorrelatedESIMPathTracer, false, MonteCarloIntegrator)
MTS_EXPORT_PLUGIN(MIEventCorrelatedESIMPathTracer, "MI path tracer");
MTS_NAMESPACE_END
