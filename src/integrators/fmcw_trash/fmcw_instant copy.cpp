 ...
 * }
 */
class MIFMCWInstantPathTracer : public MonteCarloIntegrator, public FMCWInterface {
public:
    MIFMCWInstantPathTracer(const Properties &props)
        : MonteCarloIntegrator(props), FMCWInterface(props) {
    }

    /// Unserialize from a binary data stream
    MIFMCWInstantPathTracer(Stream *stream, InstanceManager *manager)
    ...
    std::string toString() const {
        ...
        oss << "MIFMCWInstantPathTracer[" << endl
...
MTS_IMPLEMENT_CLASS_S(MIFMCWInstantPathTracer, false, MonteCarloIntegrator)
MTS_EXPORT_PLUGIN(MIFMCWInstantPathTracer, "MI path tracer");
MTS_NAMESPACE_END
