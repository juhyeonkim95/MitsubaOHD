 ...
 * }
 */
class MIFMCWInstantFrequencyPathTracer : public MonteCarloIntegrator, public FMCWInterface {
public:
    MIFMCWInstantFrequencyPathTracer(const Properties &props)
    ...
    MIFMCWInstantFrequencyPathTracer(Stream *stream, InstanceManager *manager)
    ...
    std::string toString() const {
        ...
        oss << "MIFMCWInstantFrequencyPathTracer[" << endl
...
MTS_IMPLEMENT_CLASS_S(MIFMCWInstantFrequencyPathTracer, false, MonteCarloIntegrator)
MTS_EXPORT_PLUGIN(MIFMCWInstantFrequencyPathTracer, "MI path tracer");
MTS_NAMESPACE_END
