 ...
 * }
 */
class MIFMCWFieldPathTracer : public MonteCarloIntegrator, public FMCWInterface {
public:
    MIFMCWFieldPathTracer(const Properties &props)
        : MonteCarloIntegrator(props), FMCWInterface(props) {
    }

    /// Unserialize from a binary data stream
    MIFMCWFieldPathTracer(Stream *stream, InstanceManager *manager)
    ...
    std::string toString() const {
        ...
        oss << "MIFMCWFieldPathTracer[" << endl
...
MTS_IMPLEMENT_CLASS_S(MIFMCWFieldPathTracer, false, MonteCarloIntegrator)
MTS_EXPORT_PLUGIN(MIFMCWFieldPathTracer, "MI path tracer");
MTS_NAMESPACE_END
